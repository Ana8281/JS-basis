...
class UI {
   ...
   imprimirCitas() { // Se puede aplicar destructuring desde la función...
        ...
        //read content from data base
        const objectStore = DB.transaction('citas').objectStore('citas')

        const infoTextHeading = this.textoHeading;

        const total = objectStore.count();
        total.onsuccess = function() {
            infoTextHeading(total.result)
        }
        ...
        objectStore.openCursor().onsuccess = function(e) { //this is like the forach of indexdb
            ...
            if(cursor) {
                ...
                const cita = cursor.value; //as each iteration is dynamic it should be into a constan
...
function createDB() {
    ...
    createDB.onsuccess = () => {
        ...
        //show citas to load the page (but indexedb is ready)
        ui.imprimirCitas();
    }
