...
function loadEventListeners() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
       productsCarrito = JSON.parse(localStorage.getItem('products'))  || [];
...
function removeCourse(e) {
    if (e.target.classList.contains('borrar-curso')) {
        ...
        addHtmlToCar(productsCarrito) //iterate again over the car and show html

    }
}

function synchronizeCarrito() {
